...
#define STRING_CONFIG_H_AUTHOR "(Cameron Sharp, Ender-3)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Chinese Prusa"

// Printer's unique ID, used by some programs to differentiate between machines.
// Choose your own or use a service like https://www.uuidgenerator.net/version4
#define MACHINE_UUID "34e08678-fcc5-4528-a78e-9b2dbd62bf50"
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  #else
    #define DEFAULT_Kp  20.84 //21.73
    #define DEFAULT_Ki  1.96 // 1.54
    #define DEFAULT_Kd  55.47 //76.55
  #endif
#endif // PIDTEMP
